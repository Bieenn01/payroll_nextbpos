...
class ArchivesSpecialHOT extends StatefulWidget {
  const ArchivesSpecialHOT({Key? key}) : super(key: key);

  @override
  State<ArchivesSpecialHOT> createState() => _ArchivesSpecialHOT();
}

class _ArchivesSpecialHOT extends State<ArchivesSpecialHOT> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Row(
            ...
            children: [
              Text(
                'Archives Special Holiday   Overtime Logs',
