...
class ArchivesRestdayOT extends StatefulWidget {
  const ArchivesRestdayOT({Key? key}) : super(key: key);

  @override
  State<ArchivesRestdayOT> createState() => _ArchivesRestdayOT();
}

class _ArchivesRestdayOT extends State<ArchivesRestdayOT> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Row(
            ...
            children: [
              Text(
                'Archives Restday Overtime Logs',
