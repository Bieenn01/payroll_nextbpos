...
class RestDayOT extends StatefulWidget {
  const RestDayOT({Key? key}) : super(key: key);

  @override
  State<RestDayOT> createState() => _RestDayOT();
}

class _RestDayOT extends State<RestDayOT> {
  ...
  Future<double> calculateRestDayOT(
    String userId,
    Duration duration,
  ) async {
  ...
  Future<void> _showConfirmationDialog4(DocumentSnapshot overtimeDoc) async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Restday Overtime Logs'),
