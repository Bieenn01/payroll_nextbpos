...
class ArchivesSpecialHoliday extends StatefulWidget {
  const ArchivesSpecialHoliday({Key? key}) : super(key: key);

  @override
  State<ArchivesSpecialHoliday> createState() => _ArchivesSpecialHoliday();
}

class _ArchivesSpecialHoliday extends State<ArchivesSpecialHoliday> {
  ...
  Widget _buildTable() {
    return StreamBuilder(
      stream:
          FirebaseFirestore.instance.collection('ArchivesSpecialH').snapshots(),
