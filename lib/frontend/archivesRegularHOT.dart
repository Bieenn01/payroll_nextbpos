...
class ArchivesRegularHOT extends StatefulWidget {
  const ArchivesRegularHOT({Key? key}) : super(key: key);

  @override
  State<ArchivesRegularHOT> createState() => _ArchivesRegularHOT();
}

class _ArchivesRegularHOT extends State<ArchivesRegularHOT> {
                      ...
                      const Row(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              "Archives Regular Holiday Overtime",
                              style: TextStyle(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Row(
            ...
            children: [
              Text(
                'Archives Regular Holiday Overtime Logs',
