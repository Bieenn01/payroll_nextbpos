...
class ArchivesOT extends StatefulWidget {
  const ArchivesOT({Key? key}) : super(key: key);

  @override
  State<ArchivesOT> createState() => _ArchivesOT();
}

class _ArchivesOT extends State<ArchivesOT> {
  ...
  Widget _buildTable() {
    return StreamBuilder(
      stream:
          FirebaseFirestore.instance.collection('ArchivesOvertime').snapshots(),
